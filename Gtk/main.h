/*
 * main.h - GTK+ 2.x interface for Level9 5.2
...
extern gboolean applicationExiting;
extern gboolean reinitializingEngine;

gboolean start_main_loop (void);
gboolean stop_main_loop (void);
